...
createServer({
  ...
  seeds(server) {
    ...
    server.create("car", {
      ...
      fuelType: "Hybrid",
      description: `
        Whether Panamera, Panamera Executive or Panamera Sport Turismo – the silhouette and proportions are unmistakably Porsche. Athletic, streammodeld, with clear contours and powerful muscles.

        The long wheelbase, shorter overhang at the front and longer overhang at the rear already lend visual dynamism. The prominent sculpting of the side profile creates the customary Porsche waistmodel and sense of lightness.`,
    ...
    server.create("car", {
      ...
      fuelType: "Gasomodel",
      description:
        "An intense adrenamodel rush and continuous moments of joy – driven by our most powerful eight-cylinder engine. Yet the best thing about the Cayenne Turbo remains its superior sports car feel.",
      img: "cayenne-turbo",
    });
    server.create("car", {
