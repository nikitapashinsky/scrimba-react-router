function About() {
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-8 p-6 pb-20 md:pt-16 lg:gap-12">
      <div className="max-w-prose space-y-4">
        ...
        <p>
          ...
          legendary vehicles and the latest classic cars. Decades of experience
          with classic Porsche vehicles make the Porsche Classic experts a
          competent point of contact when it comes to Genuine parts,
